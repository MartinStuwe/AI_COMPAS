...
def run_visualization(surface, scaling=1, tiny_visualization=False, FPS=30, keyboard_input=False,
                      ...
                      drift_intention=None, trial=0, attempt=0, n_run=0, code='test'):
    """
    ...
    :param drift_intention: drift having no (random) vs. malignant vs. benevolent intention
    ...
    if keyboard_input:
        level = Level(wall_list=wall_list, obstacles_list=obstacles_list,
                      ...
                      drift_ranges=drift_ranges, drift_enabled=drift_enabled, drift_intention=drift_intention,
